# R scripts generated  Sun Feb 11 15:17:29 EST 2018
...
gsms <- paste0("00000101001000110011000000001010110101010000010000",
               "0010000101100001100001111100000101101000")
sml <- c()
...
tT <- topTable(fit2, adjust="BH", sort.by="B", number=Inf)
...
tT.pathways <- causalDisturbance(tT.de.names,tT.all.names,iter = 5000, 0.2)
...
tT.pathways.clean[tT.pathways.clean$ORAFDR <0.2,]
