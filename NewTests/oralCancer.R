...
# R scripts generated  Sun Mar 11 21:48:41 EDT 2018
...
gset <- getGEO("GSE10797", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
gsms <- "1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X1X0X0X0X0X0X"
sml <- c()
