...
# R scripts generated  Sun Mar 25 00:45:29 EDT 2018
...
gset <- getGEO("GSE16515", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
gsms <- "0000101010100010101000010000010101000001001000101001"
sml <- c()
