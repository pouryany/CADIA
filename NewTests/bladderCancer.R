...
# R scripts generated  Sun Mar 11 23:31:13 EDT 2018
...
gset <- getGEO("GSE3167", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
gsms <- "00000000011111111111111111111111111111111111111111XXXXXXXXXX"
sml <- c()
