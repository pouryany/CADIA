...
# R scripts generated  Sun Mar 25 01:22:48 EDT 2018
...
gset <- getGEO("GSE83519", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
gsms <- "11111111111111111111110000000000000000000000"
sml <- c()
...
tT.deGenes <- tT.filter[tT.filter$adj.P.Val < 0.0005, ]
...
tT.pathways.clean[tT.pathways.clean$CDIST < 0.0001,]
tT.pathways.clean[tT.pathways.clean$ORAFDR <0.0001,]
