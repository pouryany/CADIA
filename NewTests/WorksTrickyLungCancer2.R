...
# R scripts generated  Sun Mar 25 00:00:18 EDT 2018
...
gset <- getGEO("GSE10245", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
gsms <- "1101000111100100111011111110101101011110111010110111011111"
sml <- c()
