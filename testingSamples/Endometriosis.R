...
# R scripts generated  Wed Feb 21 13:55:24 EST 2018
...
gset <- getGEO("GSE5108", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
tT.pathways <- causalDisturbance(tT.de.names,tT.all.names,iter = 10000, 0.5)
