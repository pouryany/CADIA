...
# R scripts generated  Tue Feb 20 22:04:22 EST 2018
...
gset <- getGEO("GSE41969", GSEMatrix =TRUE, AnnotGPL=FALSE)
if (length(gset) > 1) idx <- grep("GPL16230", attr(gset, "names")) else idx <- 1
gset <- gset[[idx]]
...
select(org.Hs.eg.db, tT$SYMBOL,"ENTREZID")
...
tT.pathways <- causalDisturbance(tT.de.names,tT.all.names,iter = 50000, 0.5)
